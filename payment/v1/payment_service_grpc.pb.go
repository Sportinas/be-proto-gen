...
const (
	...
	PaymentService_CheckPaymentStatus_FullMethodName = "/payment.v1.PaymentService/CheckPaymentStatus"
...
func (UnimplementedPaymentServiceServer) CheckPaymentStatus(context.Context, *CheckPaymentStatusRequest) (*CheckPaymentStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckPaymentStatus not implemented")
}
